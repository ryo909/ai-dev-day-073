import './style.css';
const PROFILE = {"day":"Day073","title":"Market Bag Balancer","display_name_ja":"買い物袋かたより直し","one_sentence":"買った物を重さと割れやすさで袋に分けるツール","purpose_line_ja":"買い物袋の重さ偏りを直すツールです。","use_case_line_ja":"会計後に袋へ詰める前、重さが偏りそうな時に使います。","how_it_works_line_ja":"品物と袋数を入れると、配分が出ます。","core_action":"sort_baskets","family":"market_bag_balance","mechanic":"sort_baskets","input_style":"basket_items","output_style":"load_split","output_label":"ここを見ればOKです","audience_promise":"レジ台で詰め直す回数を減らせる。","publish_hook":"買った物の重さと壊れやすさを入れると、袋ごとの重さ差と避ける組み合わせが見える。","engine":"brief_driven","interaction_archetype":"sort_baskets","page_archetype":"laundry_baskets","ui_variant":"market","intro_variant":"market_bag_balance","interaction_model":"editable_items_to_balanced_bags","primary_layout":"item_weight_editor_with_two_bag_result","result_presentation_style":"bag_weight_bars_and_fragile_top_list","palette_motif":"買い物袋グリーン","main_cta":"帰り道の買い物で試す","input_panel_title":"品物と重さを足す","sample_panel_title":"帰り道の買い物で試す","guide_panel_title":"重さ偏りの見どころ","hero_panel_label":"袋ごとの重さ","output_shape":"laundry_baskets","state_model":"sort_baskets_state","core_loop":"basket_items -> sort_baskets -> load_split","component_pack":"laundry_baskets+load_split","scaffold_id":"brief_canvas","single_shot_text_generator":false};
